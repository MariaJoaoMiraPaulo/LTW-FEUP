        ...
        <div class="editRestaurant">
            <form class="formEditRestaurant" action="../dbActions/editRestaurant.php" method="post">
                <fieldset>
                    ...
                    <input type="text" name="restAddress"  value="<?php echo getRestaurantInfoById($id,'address')?>"><br>
                    <input type="text" name="restLocation" value="<?php echo getRestaurantInfoById($id,'location')?>"><br>
                    <input type="url" name="restWebSite"  value="<?php echo getRestaurantInfoById($id,'website')?>"><br>
                    <input type="text" name="restPrice" value="<?php echo getRestaurantInfoById($id,'price')?>"><br>
